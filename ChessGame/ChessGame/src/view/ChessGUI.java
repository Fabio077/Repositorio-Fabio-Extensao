...
public class ChessGUI extends JFrame {
    ...
    private static Color LIGHT_SQ = Color.WHITE;
    private static Color DARK_SQ  = new Color(30, 144, 255); // Azul (Dodger Blue)

    // Temas de cores para o tabuleiro
    private static final Color[][] TAB_TEMAS = {
        {Color.WHITE, new Color(30, 144, 255)}, // Padrão: branco e azul
        {new Color(240, 217, 181), new Color(181, 136, 99)}, // Tradicional: bege e marrom
        {new Color(220, 220, 220), new Color(128, 128, 128)}, // Cinza claro e escuro
        {new Color(255, 255, 204), new Color(102, 153, 0)}, // Amarelo claro e verde
        {new Color(224, 255, 255), new Color(70, 130, 180)}  // Azul claro e azul escuro
    };
    ...
    public void alterarCoresTabuleiro(int tema) {
        ...
        LIGHT_SQ = TAB_TEMAS[tema][0];
        DARK_SQ = TAB_TEMAS[tema][1];
        temaAtual = tema;
        refresh();
    }
    ...
    private JMenuBar buildMenuBar() {
        ...
        for (int i = 0; i < nomesTemas.length; i++) {
            final int temaIdx = i;
            JMenuItem item = new JMenuItem(nomesTemas[i]);
            item.addActionListener(e -> alterarCoresTabuleiro(temaIdx));
            temaMenu.add(item);
        }
        mb.add(temaMenu);
        ...
        for (int i = 1; i <= 4; i++) {
            ...
            dificuldadeMenu.add(item);
        }
        mb.add(dificuldadeMenu);
        return mb;
    }
